...
class RadioStationTaskCell: UITableViewCell, CustomPresentCellProtocol {
    ...
    required init(reuseIdentifier: String) {
        ...
        // 74 144 226
        self.timeImageView = UIImageView(frame: CGRectMake(10, 40, 12, 12))
        ...
        self.timeLabel = UILabel(frame: CGRectMake(30, 40, 300, 12))
        self.timeLabel?.font = UIFont.systemFontOfSize(12)
        
        // 208 2 27
        self.emergencyLabel = UILabel(frame: CGRectMake(310, 40, 100, 12))
        self.emergencyLabel?.font = UIFont.boldSystemFontOfSize(12)
        
        // 0 0 0
        self.locationImageView = UIImageView(frame: CGRectMake(10, 70, 12, 12))
        ...
        self.locationLabel = UILabel(frame: CGRectMake(30, 70, 300, 12))
        self.locationLabel?.font = UIFont.systemFontOfSize(12)
    }
    
    func assignValue(title: String, time: NSDate, location: String) {
        ...
        timeAttrStr.setAttributes([
                NSForegroundColorAttributeName: UIColor(red: 74/255, green: 144/255, blue: 226/255, alpha: 1)
            ], range: NSMakeRange(0, timeStr.characters.count))
        self.timeLabel?.attributedText = timeAttrStr
